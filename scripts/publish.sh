#!/bin/bash
# Build and publish colcon-fish to PyPI
#
...
do_upload() {
    ...
    if [ "$1" = "test" ]; then
        ...
        echo "Install with: pip install --index-url https://test.pypi.org/simple/ colcon-fish"
    else
        echo "Uploading to PyPI..."
        python3 -m twine upload dist/* --verbose
        echo "Install with: pip install colcon-fish"
    fi
}
